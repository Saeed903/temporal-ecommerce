...
func RemoveFromCartHandler(w http.ResponseWriter, r *http.Request){
	...
	removeItem := app.RemoveFromCartSignal{Route: app.RouteTypes.REMOVE_FROM_CART, Item: item}

	err = temporal.SignalWorkflow(context.Background(), vars["workflowID"], "", app.SignalChannels.REMOVE_FROM_CART_CHANNEL, removeItem)
	if err != nil {
		WriteError(w, err)
		return
	}
